# Generated by Powerlevel10k configuration wizard on 2023-11-27 at 11:22 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=219
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=237 # 254
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BOLD=
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=14
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=14
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=7  #14
  typeset -g POWERLEVEL9K_IP_FOREGROUND=241
